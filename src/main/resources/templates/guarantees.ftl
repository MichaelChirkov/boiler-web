    ...
    <div style="display:flex">
        ...
        <div class="shoes-grid">
            ...
            <div class="category-head">
                <h5 class="latest-product">Гарантии</h5>
            </div>

            <div class="boil-text">
              <!--   <p><h3><span style="font-family:arial,helvetica,sans-serif">Гарантии</span></p></h3> -->
<br>
                <p><span>Мы на протяжении многих лет являемся официальным партнером ООО &laquo;Завод Котельного Оборудования&raquo; и осуществляем полный спектр услуг от продажи, поставки, монтажа, гарантийного и постгарантийного обслуживания оборудования завода.</span></p>

                <p><span>ООО &laquo;Завод Котельного Оборудования&raquo; является специализированным предприятием, основным направлением деятельности которого является производство широкого спектра продукции теплоэнергетического комплекса.</span></p>

                <p><span>Продукция выпускается на собственных производственных мощностях предприятия в г.Туймазы. Высококвалифицированный персонал, наличие современного технологического оборудования, применение современных и практических технических решений позволяет выпускать продукцию высочайшего качества.</span></p>
                <br>
                <p>Сертификат официального партнера:</p>
                <img class="guarantees image img-small" src="/images/sertificat.jpg" alt="Для увеличения нажмите на изображение">
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
