        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">Характеристики <i class="caret"></i>
        ...
        <div class="span9" id="content">
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">Список запчастей и комплектующих</div>
                    </div>
                        ...
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                ...
                                <tr class="odd gradeX">
                                    <td>${sparPart.id}</td>
                                    <td>${sparPart.name}</td>
                                    <td>${sparPart.model}</td>
                                    <td>${sparPart.price}</td>
                                    <td>
                                        <center><button class="btn btn-primary"><i class="icon-pencil icon-white"></i> Edit</button></center>
                                    </td>

                                    <td>
                                        <center><button class="btn btn-danger"><i class="icon-remove icon-white"></i> Delete</button></center>
                                    </td>
                                </#list>
                                </tbody>
                            </table>
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form class="form-horizontal" method="post" action="/admin/spar-parts/add" enctype="multipart/form-data">
                                <fieldset>
                                    <legend>Добавить запчасть</legend>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="focusedInput">Модель</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="" name="model">
                                        </div>
                                    </div>
                                    <div class="control-group">
