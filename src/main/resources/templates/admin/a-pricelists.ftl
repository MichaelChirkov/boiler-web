...
<head>
    <title>Admin panel | Прайс-листы</title>
    <!-- Bootstrap -->
        ...
        <div class="span9" id="content">
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">Список прайс-листов</div>
                    </div>
                    <div class="block-content collapse in">
                        <div class="span12">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                ...
                                <tbody>
                                <#list pricelists as pricelist>
                                <tr class="odd gradeX">
                                    <td>${pricelist.id}</td>
                                    <td>${pricelist.name}</td>
                                    <td>
                                        <center><a href="/admin/pricelists/edit?id=${pricelist.id}"><button class="btn btn-primary"><i class="icon-pencil icon-white"></i>Изменить</button></a></center>
                                    </td>

                                    <td>
                                        <center><a href="/admin/pricelists/delete?id=${pricelist.id}"><button class="btn btn-danger"><i class="icon-remove icon-white"></i>Удалить</button></a></center>
                                    </td>
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <form class="form-horizontal" method="post" action="/admin/pricelists/add" enctype="multipart/form-data">
                                <fieldset>
                                    <legend>Добавить прайс-лист</legend>
                                    <div class="control-group">
                                    <label class="control-label" for="focusedInput">Название</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" required id="focusedInput" type="text" value="" name="name">
                                    </div>
                                </div>
                                    <div class="control-group">
                                        <label class="control-label" for="focusedInput">Название на английском</label>
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" required type="text" value="" name="engName">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="fileInput">Выберите файл</label>
                                        <div class="controls">
                                            <input class="input-file uniform_on" id="fileInput" type="file" name="pdfFile">
                                        </div>
                                    </div>
