                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            ...
                            <form class="form-horizontal" method="post" action="/admin/categories/edit" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="focusedInput" type="text" value="${category.name}" name="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                    <textarea class="input-xlarge textarea" name="shortDescription" placeholder="Введите текст ..."
                              style="width: 700px; height: 200px">${category.shortDescription}</textarea>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="fileInput">Изображение</label>
                                        <div class="controls">
                                            <input class="input-file uniform_on" id="fileInput" type="file" name="imgUrl">
                                        </div>
                                    </div>
                                    <div class="control-group">
