...
<head>
    <title>Admin panel | Горячий товар</title>
    <!-- Bootstrap -->
            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <#if products??>
                            <form class="form-horizontal" method="post" action="/admin/hot-product">
                                <fieldset>
                                    <legend>Выбор горячего продукт</legend>
                                    <div class="control-group">
                                        <label class="control-label">Горячий товар</label>
                                        <div class="controls">
                                            <select class="span6 m-wrap" name="newHotProduct">   <!--// onchange="this.form.submit() -->
                                                <#if hotProduct??>
                                                    <option selected value="${hotProduct.id}">${hotProduct.name}</option>
                                                </#if>
