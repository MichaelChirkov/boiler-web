...
<html>
<head>
    <title>ProКотлы | Прайс-листы</title>
    ...
    <div style="display:flex">
        ...
        <div class="shoes-grid">
            ...
            <div class="category-head">
                <h5 class="latest-product">Прайс-листы</h5>
            </div>

            <div class="boil-text">
                <!--    <p><h3><span>Доставка</span></p></h3> -->
                <br>
                <p><b><span>Актуальные прайс листы:</span></b></p>
                <ul class="pricelists">
                <#list pricelists as pricelist>
                   <li><a href="/pdf?id=${pricelist.id}" target="_blank"><img src="/images/pdf.png" alt = "Нажмите для скачивания"> ${pricelist.name}</a></li>
                </#list>
                <br>
                </ul>
            </div>
